...
def tokenize_dict(dict_of_file_text, tokenize=tokenize_clean):
    """ Takes the output file-text dict from load_texts_as_strings and tokenizes using whichever function you want.
    """
    return

def load_texts_as_string(filenames):
    """ Input is a list, output is a dict """
